...
<template>
 ...
 <DogProfile v-if="$route.params.dogName === 'samira'">
  ...
  <template v-slot:modelContent>
   ...
   <li>Currently training for CGC!</li>
   <br />

   Agility Titles:
   <li>TBD!</li>
   <br />
   Sami comes from Timeless Aussies:
 ...
 <DogProfile v-if="$route.params.dogName === 'cammi'">
  ...
  <template v-slot:modelContent>
   ...
   <br />
   <p>
    Cammi, also known as Snowbelts Charming Invitation, graced our lives for an impressive 16 years,
    leaving behind a legacy that continues to shine. Her journey was marked by remarkable
    achievements, positioning her as a true champion within our family. An avid competitor, Cammi &
    Halee dedicated their weekends to the pursuit of excellence in the world of Agility, competing
    in the highest categories. As a testament to her prowess, Cammi & Halee were invited to
    participation in the prestigious 2008 AKC Agility Nationals in Concord, North Carolina.
    <br /><br />
   ...
   <br />
   Cammi comes from Snowbelt Aussies.
 ...
 <DogProfile v-if="$route.params.dogName === 'savannah'">
  ...
  <template v-slot:modelContent>
   Savannah was very eager to please and showed a lot of promise in Agility! Unfortunately her
   competing career was cut short when I went off to college. She lived a long and happy life, up
   until age 16 and a half! She is the oldest Snowbelt Aussie on record. <br /><br />
   Savannah comes from Snowbelt Aussies:
 ...
 <DogProfile v-if="$route.params.dogName === 'vee'">
  ...
  <template v-slot:modelContent>
   ...
   <br />
   Vee comes from Snowbelt Aussies:
   <li><b>Sire:</b> ROMXI CH Briarbrook Sharp Dressed Man</li>
 ...
 <DogProfile v-if="$route.params.dogName === 'meggie'">
  ...
  <template v-slot:modelContent>
   <p>
    Meggie inspired me to get started in Agility. She was the most loyal, happy, and eager to please
    dog. She was willing to try most things, but the teeter was scary for her.
   </p>
   <br />
